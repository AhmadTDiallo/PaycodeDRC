                ...
                <div className="relative flex-shrink-0">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-4 md:p-6 text-white z-10">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-4 space-y-1 sm:space-y-0 text-white/90">
                          ...
                          <div className="flex items-center">
                            ...
                            <span className="text-xs md:text-sm">Par {selectedArticle.author}</span>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  {!selectedArticle.imageUrl && !(selectedArticle.imageUrls && selectedArticle.imageUrls.length > 0) && (
                    <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-6 md:p-8 text-white">
                      <div className="mb-4">
                        <Badge className="bg-white/20 text-white px-3 py-1 text-sm font-semibold backdrop-blur-sm">
                          {selectedArticle.category}
                        </Badge>
                      </div>
                ...
                <div className="flex-1 overflow-y-auto p-4 md:p-8 min-h-0">
                  ...
                  <div className="mb-6 md:mb-8">
                    <div className="bg-blue-50 border-l-4 border-blue-500 p-4 md:p-6 rounded-r-lg">
                      <h3 className="text-base md:text-lg font-semibold text-blue-900 mb-2 md:mb-3">Résumé</h3>
                  ...
                  <div className="prose prose-sm md:prose-lg max-w-none">
                    <div className="text-gray-800 leading-relaxed text-sm md:text-lg whitespace-pre-wrap">

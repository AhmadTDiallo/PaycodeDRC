...
const translations = {
  fr: {
    ...
    'solutions.solution5Title': 'Edapt',
    ...
    'edapt.feature1Desc': 'Authentification sécurisée par reconnaissance faciale et palmaire pour une identification fiable des utilisateurs.',
    'edapt.feature2Title': 'Portefeuille Électronique',
    'edapt.feature2Desc': 'Accès complet aux portefeuilles électroniques et aux comptes bancaires pour une gestion financière simplifiée.',
    'edapt.feature3Title': 'Transactions Hors Ligne',
    'edapt.feature3Desc': 'Paiements en temps réel sans connexion internet requise, parfait pour les zones reculées.',
    'edapt.feature4Title': 'Interopérabilité',
    'edapt.feature4Desc': 'Compatible avec les services financiers, d\'aide gouvernementale, de santé et agricoles.',
    
    'edapt.usecasesTitle': 'Cas d\'Usage',
    'edapt.usecase1Title': 'Services Financiers',
    'edapt.usecase1Desc': 'Accès bancaire sécurisé et paiements numériques pour les institutions financières et leurs clients.',
    'edapt.usecase2Title': 'Aide Gouvernementale',
    'edapt.usecase2Desc': 'Distribution efficace des aides sociales et programmes gouvernementaux avec authentification biométrique.',
    'edapt.usecase3Title': 'Santé & Agriculture',
    'edapt.usecase3Desc': 'Paiements pour services de santé et transactions agricoles dans des environnements à connectivité limitée.',
    
    'edapt.benefitsTitle': 'Avantages Clés',
    'edapt.benefit1Title': 'Sécurité Renforcée',
    'edapt.benefit1Desc': 'L\'authentification biométrique élimine les risques de fraude et de vol d\'identité.',
    'edapt.benefit2Title': 'Accès Universel',
    'edapt.benefit2Desc': 'Fonctionne dans les zones les plus reculées sans infrastructure internet.',
    'edapt.benefit3Title': 'Simplicité d\'Usage',
    'edapt.benefit3Desc': 'Interface intuitive accessible même aux utilisateurs peu familiers avec la technologie.',
    'edapt.benefit4Title': 'Réduction des Coûts',
    'edapt.benefit4Desc': 'Diminue les coûts opérationnels et d\'infrastructure pour les institutions.',
    'edapt.benefit5Title': 'Conformité Réglementaire',
  ...
  en: {
    ...
    'solutions.edaptTitle': 'Edapt',
    'solutions.edaptDesc': 'Paycode\'s EDAPT (Electronic Data And Payments Technology) is a robust platform that combines secure biometric identification with offline-capable digital payments—even in remote locations. Key features include biometric identity & authentication (face/palm recognition), electronic wallet & bank account access, offline, real‑time transactions—no internet required, and interoperability across financial, government aid, health, and agri services.',

    // EDAPT Section
    'edapt.title': 'EDAPT - Electronic Data And Payments Technology',
    'edapt.subtitle': 'A robust platform that combines secure biometric identification with offline-capable digital payments—even in remote locations.',
    
    'edapt.feature1Title': 'Biometric Identification',
    'edapt.feature1Desc': 'Secure authentication through face and palm recognition for reliable user identification.',
    'edapt.feature2Title': 'Electronic Wallet',
    'edapt.feature2Desc': 'Full access to electronic wallets and bank accounts for simplified financial management.',
    'edapt.feature3Title': 'Offline Transactions',
    ...
    'edapt.usecase1Desc': 'Secure banking access and digital payments for financial institutions and their clients.',
    'edapt.usecase2Title': 'Government Aid',
    'edapt.usecase2Desc': 'Efficient distribution of social benefits and government programs with biometric authentication.',
    'edapt.usecase3Title': 'Health & Agriculture',
    'edapt.usecase3Desc': 'Healthcare payments and agricultural transactions in limited connectivity environments.',
    
    'edapt.benefitsTitle': 'Key Benefits',
    'edapt.benefit1Title': 'Enhanced Security',
    'edapt.benefit1Desc': 'Biometric authentication eliminates fraud risks and identity theft.',
    'edapt.benefit2Title': 'Universal Access',
    'edapt.benefit2Desc': 'Works in the most remote areas without internet infrastructure.',
    'edapt.benefit3Title': 'Ease of Use',
    'edapt.benefit3Desc': 'Intuitive interface accessible to users unfamiliar with technology.',
    'edapt.benefit4Title': 'Cost Reduction',
    'edapt.benefit4Desc': 'Reduces operational and infrastructure costs for institutions.',
    'edapt.benefit5Title': 'Regulatory Compliance',
    'edapt.benefit5Desc': 'Meets international security and data protection standards.',
    'edapt.benefit6Title': 'Scalability',
    'edapt.benefit6Desc': 'Easily adapts to growing needs and geographical expansion.',
